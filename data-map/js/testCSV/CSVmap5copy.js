...
function setup() {
  ...
  for(let i = 0; i < countries.getRowCount(); i++ ){
    ...
    // var greenTeaMarker = L.layerGroup();
    // var blackTeaMarker = L.layerGroup();
        ...
        // let blackTeavalue = "black";
        // if (tea.includes(blackTeavalue)) {
        //   console.log("The word black is in the string.");
        //   var blackTeaMarker = L.layerGroup();
        //   L.marker([lat,long])
        //   .bindPopup('<h1>'+ country + '</h1><img src= "assets/images/'+ locationImage +'"/><p>Trade Value: ' + tradeValue +'</p>')
        //   .addTo(map);
        // } else {
        //   console.log("The word black is not in the string.");
        // }
        //
        // var overlays = {
        //     "Green Tea": greenTeaMarker,
        //     "Black Tea": blackTeaMarker,
        // };
        //
        //   //null allows mutiple layers to be checked
